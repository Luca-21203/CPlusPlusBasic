...
// Funció que indica si guanyem o perdem
...
int main() {
    ...
    while (partidaNova == "s" || partidaNova == "si") {
        ...
        bool guanyat = trobada(nTalaiot);

        if (guanyat) {
            punts++;
            cout << "Has guanyat! Punts actuals: " << punts << endl;
        } else {
            cout << "Has perdut! Punts totals aconseguits: " << punts << endl;
            punts = 0; // reinicia punts
        }
